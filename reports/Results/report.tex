...
\end{adjustbox}
\\
\\Total issues examined: 36\\Final Score for issue tracker: 8.64 / 11.00 \\ \\\begin{adjustbox}{center}
	\begin{tikzpicture}
	\begin{axis}[
	title={\textbf{Conversion Quality Graph}},
	width=7in,
	...
	\addplot[ybar] coordinates {
		...
		(Information Preservation,100.00)
		(User Identification,100.00)
		(Rendering Errors,87.96)
		(Other Information Not Preserved, 0.00)
	};
	\end{axis}
	\end{tikzpicture} 
\end{adjustbox}
\\\section{Issue Tracker Redmine : Project Test Credit System}
\textbf{Conversion Quality Test}\\
\begin{adjustbox}{center}
	\renewcommand{\arraystretch}{1.5}
	\begin{tabular}{ p{6cm} | c | c }
...
\\Total issues examined: 55\\Final Score for issue tracker: 8.58 / 11.00 \\ \\\begin{adjustbox}{center}
	...
	\addplot[ybar] coordinates {
		(Successful Import,100.00)
		(Information Preservation,99.09)
		(User Identification,100.00)
		(Rendering Errors,87.27)
		(Other Information Not Preserved, 0.00)
	};
	\end{axis}
	\end{tikzpicture} 
