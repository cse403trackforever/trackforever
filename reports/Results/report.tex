...
\end{adjustbox}
\\
\\Total issues examined: 9\\Final Score for issue tracker: 7.33 / 11.00 \\ \\\begin{adjustbox}{center}
	\begin{tikzpicture}
	\begin{axis}[
	...
	\addplot[ybar] coordinates {
		(Successful Import,66.67)
		(Information Preservation,66.67)
		(User Identification,66.67)
		(Rendering Errors,66.67)
		(Other Information Not Preserved, 66.67)
	};
	\end{axis}
	\end{tikzpicture} 
\end{adjustbox}
\\\section{Issue Tracker GitHub : Project Project 2}
\textbf{Conversion Quality Test}\\
\begin{adjustbox}{center}
	\renewcommand{\arraystretch}{1.5}
	\begin{tabular}{ p{6cm} | c | c }
...
\end{adjustbox}
\\
\\Total issues examined: 36\\Final Score for issue tracker: 6.03 / 11.00 \\ \\\begin{adjustbox}{center}
	\begin{tikzpicture}
	\begin{axis}[
	title={\textbf{Conversion Quality Graph}},
	width=7in,
	...
	\addplot[ybar] coordinates {
		...
		(Information Preservation,70.83)
		(User Identification,50.00)
		(Rendering Errors,48.15)
		(Other Information Not Preserved, 37.50)
	};
	\end{axis}
	\end{tikzpicture} 
\end{adjustbox}
...
\\Total issues examined: 89\\Final Score for issue tracker: 6.82 / 11.00 \\ \\\begin{adjustbox}{center}
	...
	\addplot[ybar] coordinates {
		(Successful Import,100.00)
		(Information Preservation,67.42)
		(User Identification,50.00)
		(Rendering Errors,72.28)
		(Other Information Not Preserved, 47.75)
	};
	\end{axis}
	\end{tikzpicture} 
\end{adjustbox}
